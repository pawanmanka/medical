                    ...
                    <!-- MAIN MENU -->
                      <nav class="wsmenu clearfix">
                        <ul class="wsmenu-list">
                            ...
                            <li class="nl-simple" aria-haspopup="true"><a href="{{ url('about-us') }}">About Arogyarth</a></li>								
                              <!-- PAGES -->
                            ...
                            <li class="nl-simple" aria-haspopup="true"><a href="{{ url('how-we-work') }}">How we work </a></li>
